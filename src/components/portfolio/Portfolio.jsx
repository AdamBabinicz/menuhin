    ...
    <section id="koncerty">
      ...
      <div className="container portfolio__container">
        ...
        {/* <article className="portfolio__item">
          ...
          <h3>Koncert w Oakland Auditorium (1924)</h3>
          <p>Scène de Ballet Bériota</p>
          <div className="portfolio__item-cta">
            <a
              href="#"
              className="btn"
        ...
        <article className="portfolio__item">
          ...
          <h3>W roku 1929 zadebiutował w Berlinie</h3>
          <p>Koncerty Bacha, Beethovena i Brahmsa</p>
          <div className="portfolio__item-cta">
            <a
              href="#"
              className="btn"
        ...
        <article className="portfolio__item">
          ...
          <h3>W roku 1944 poznał Belę Bartóka</h3>
          <p>Węgierski kompozytor zadedykował mu swą Sonatę na skrzypce solo</p>
          <div className="portfolio__item-cta">
            <a
              href="#"
              className="btn"
        ...
        <article className="portfolio__item">
          ...
          <h3>Lipskie Targi Wiosenne (1961)</h3>
          <p>Franz Konwitschny i Yehudi Menuhin</p>
          <div className="portfolio__item-cta">
            <a
              href="#"
              className="btn"
        ...
        <article className="portfolio__item">
          ...
          <h3>Yehudi Menuhin z Ravim Shankarem (1968)</h3>
          <p>Płyta „West Meets East”</p>
          <div className="portfolio__item-cta">
            <a
              href="#"
              className="btn"
        ...
        <article className="portfolio__item">
          ...
          <h3>Yehudi Menuhin, Alan Clare i Stephane Grappelli</h3>
          <p>Muzyczni przyjaciele</p>
          <div className="portfolio__item-cta">
            <a
              href="#"
              className="btn"
